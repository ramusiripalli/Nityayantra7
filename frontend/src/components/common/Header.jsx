...
export const Header = () => {
  ...
  return (
    <header className="sticky top-0 z-40 shadow-md">
      ...
      {/* DESKTOP & TABLET TOP NAVBAR (≥768px): UNTOUCHED GRADIENT BAR (~74px Height) */}
      <div className="hidden md:block bg-[linear-gradient(90deg,#2448F5,#7B2FE8,#E52D8C,#FF5A36)] text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-[74px] gap-4">
            ...
            {/* Right: Main Navigation Links + Actions (Cart & Profile) */}
      ...
      {/* MOBILE TOP NAVBAR (<768px): GRADIENT BRAND HEADER WITH EMBEDDED SEARCH & 5x2 CATEGORY GRID */}
      <div className="md:hidden bg-[linear-gradient(90deg,#2448F5,#7B2FE8,#E52D8C,#FF5A36)] text-white shadow-sm">
        
        {/* Section 1: Brand / Action Bar (~64-70px) */}
        <div className="px-3.5 pt-3 pb-2 flex items-center justify-between">
          
          {/* Mobile Left: Hamburger Menu + Logo + Brand Title & Tagline */}
          <div className="flex items-center gap-2.5">
            <button
              onClick={() => setMobileMenuOpen(!mobileMenuOpen)}
              className="p-1.5 -ml-1 text-white rounded-lg hover:bg-white/10 transition-colors focus:outline-none cursor-pointer"
            ...
            <Link to="/" className="flex items-center gap-2.5">
              <div className="relative rounded-xl overflow-hidden border border-white/20 bg-slate-900 w-[38px] h-[38px] shrink-0">
              ...
              <div className="flex flex-col leading-tight">
                ...
                <span className="text-white/90 font-semibold text-[9.5px] tracking-wide mt-0.5">
        ...
        {/* Section 2: Prominent Mobile Search Bar */}
      ...
      {/* Section 3: Category Menu (Horizontal Scroll for Desktop, 5x2 Grid for Mobile) */}
      <CategoryNavigation />
